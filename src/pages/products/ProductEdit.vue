...
onMounted(async () => {
  ...
  form.title = productRes.data.title;
  form.description = productRes.data.description;
  form.image = productRes.data.image;
  form.price = productRes.data.price;
});
...
const onSubmit = async () => {
  ...
  try {
    const res = await axios.put(`products/${params.id}`, form);
